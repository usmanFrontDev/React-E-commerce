...
function WishList({productsInWishList, handlewisLisRemove}) {
  return (
    <div className="wishlistmain">
      ...
      <div className="wishdynamiccontent">
        ...
        productsInWishList.map((wishOneItem, index)=>  <OneWishListItem handlewisLisRemove={handlewisLisRemove} key={index} wishOneItem={wishOneItem}/>)
        }
      </div>
    </div>
  )
